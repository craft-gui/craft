...
pub(super) fn find_pointer_capture_target(message: &CraftMessage) -> Option<Rc<RefCell<dyn ElementInternals>>> {
    // 9.4 Implicit pointer capture
    // https://w3c.github.io/pointerevents/#implicit-pointer-capture
    //
    let pointer_capture_element_id: Option<Weak<RefCell<dyn ElementInternals>>> = DOCUMENTS.with_borrow_mut(|docs| {
