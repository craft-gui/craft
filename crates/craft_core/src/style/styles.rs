...
impl Style {
    ...
    pub fn scale(&mut self, scaling_factor: f64) {
        let scaling_factor = scaling_factor as f32;

        let scrollbar_width = self.scrollbar_width * scaling_factor;
        let margin = Self::scale_trlb_unit(&self.margin, scaling_factor);
        ...
        *self = Style {
            ...
            // Don't scale the font_size, this is done externally.
