...
use retgui_retained::elements::{AsElement, DynElement, Element as RetainedElement, ElementInternals};
...
pub struct Conditional {
    pub inner: retgui_retained::elements::Container,
...
impl Conditional {
    ...
    pub fn new(signal: Signal<bool>) -> Self {
        let inner = retgui_retained::elements::Container::new();
