...
use retgui_retained::elements::{AsElement, ElementInternals, SliderDirection};
use retgui_retained::{Brush, Color};
...
#[derive(Clone)]
pub struct Slider {
    pub inner: retgui_retained::elements::Slider,
}
...
impl Slider {
    pub fn new(thumb_size: impl Bindable<f64>) -> Self {
        let inner = retgui_retained::elements::Slider::new(1.0);
