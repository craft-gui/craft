use craft::animations::{Animation, KeyFrame, LoopAmount, TimingFunction};
...
impl Component for AnimationsExample {
    ...
    fn view(_context: &mut Context<Self>) -> ComponentSpecification {
        let growing_animation = Animation::new("growing_animation", Duration::from_secs(5), TimingFunction::EaseOut)
            .push(
                KeyFrame::new(0.0)
        ...
        let moving_animation = Animation::new("moving_animation", Duration::from_secs(5), TimingFunction::Ease)
            .push(KeyFrame::new(0.0).push(StyleProperty::Background(palette::css::BLUE)).push(StyleProperty::Inset(
                TrblRectangle::new(Unit::Px(100.0), Unit::Px(0.0), Unit::Px(0.0), Unit::Px(0.0)),
            )))
            .push(KeyFrame::new(50.0).push(StyleProperty::Background(palette::css::MAGENTA)).push(
                StyleProperty::Inset(TrblRectangle::new(
                    Unit::Px(150.0),
                    Unit::Px(0.0),
                    Unit::Px(0.0),
                    Unit::Px(250.0),
        ...
        let text_animation = Animation::new("text_animation", Duration::from_secs(5), TimingFunction::Ease)
            .push(
                KeyFrame::new(0.0)
                    .push(StyleProperty::Background(palette::css::RED))
        ...
        let animation_examples: Vec<ComponentSpecification> = vec![
            ...
            Container::new()
                ...
                .component(),
            Text::new("Why, Hello!").push_animation(text_animation).component(),
        ];
        ...
        container.extend_children_in_place(animation_examples);
