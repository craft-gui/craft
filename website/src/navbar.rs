...
impl Component<WebsiteGlobalState> for Navbar {
        ...
        Container::new()
            ...
            .push(
                Container::new()
                    ...
                    .align_items(AlignItems::Center)
                    .push(create_link("OKU", "/").font_size(32.0).font_weight(Weight::BOLD).margin("0px", "24px", "0px", "0px"))
                    .push(
                        create_link("Home", "/").margin("0px", "12px", "0px", "0px"),
                    )
    ...
    fn update(_state: &mut Self, global_state: &mut WebsiteGlobalState, _props: &Self::Props, event: Event) -> UpdateResult {
