...
impl Component<WebsiteGlobalState> for TextState {
    type Props = ();

    fn view(_state: &Self, _global_state: &WebsiteGlobalState, _props: &Self::Props, _children: Vec<ComponentSpecification>) -> ComponentSpecification {
        Container::new()
    ...
    fn update(_state: &mut Self, _global_state: &mut WebsiteGlobalState, _props: &Self::Props, event: Event) -> UpdateResult {
