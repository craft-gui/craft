...
impl Component<WebsiteGlobalState> for Counter {
    type Props = ();

    fn view(state: &Self, _global_state: &WebsiteGlobalState, _props: &Self::Props, _children: Vec<ComponentSpecification>) -> ComponentSpecification {
        Container::new()
