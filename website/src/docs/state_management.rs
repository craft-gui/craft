...
#[derive(Default)]
pub(crate) struct StateManagementPage {

}

impl Component for StateManagementPage {
    ...
    fn view(&self, _global_state: &Self::GlobalState, _props: &Self::Props, _children: Vec<ComponentSpecification>, _id: ComponentId, _window: &WindowContext) -> ComponentSpecification {
        Container::new()
            ...
            .push(Text::new("State Management").font_size(32.0).margin("0px", "0px", "25px", "0px").font_weight(Weight::BOLD))
